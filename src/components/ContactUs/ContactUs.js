				...
				<div className="contact_us">
					...
					<div className="row mt-4">
						<div className="offset-md-1 col-md-10 contact_notice">
							...
							aggregates all songs that users put up as NFTs and is not partnering with any of the artists
							displayed on the website. If you want to contact one of the artists listed here, you must
							contact them directly through other social media platforms. We are not responsible if
							someone else puts up an artists' song as an NFT on our platform and cannot assist you
							regarding the same.
						</div>
					</div>
							...
							<div className="contact_us_div">
								<div className="contact_us_box col-md-12 p-3 shadow mb-5">
									<form
										...
										action="https://getform.io/f/91471bcd-4363-49f9-9762-bb91ed85745b"
										method="POST"
									>
										<div className="row">
											<div className="col-md-5">
												...
												<div className="row mt-5">
													<div className="col-md-10 col-8 provide_email">
														If you don't provide an email, we will not be able to respond to
														your query!
													</div>
												</div>
											</div>
											...
											<div className="col-md-6 col-10 mt-3 message_box">
												<div className="form-group">
													...
													<textarea
														className="form-control textarea_contact"
														name="message"
														rows="8"
														required
													></textarea>
